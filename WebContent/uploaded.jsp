...
<%
	...
	List<VideosBean> result = dao.videosBean(str1);
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
						...
						<div class="inner-agile-w3l-part-head">
					            <h3 class="w3l-inner-h-title">投稿记录</h3>
							...
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									...
									<%if(number!=0){ %>
										...
										<tbody>
										<% 
										for(VideosBean v : result){ %>
										  <tr>
											<td><%=a %></td>
											<td class="w3-list-info"><a href="single.jsp?vid=<%= v.getVideoid()%>"><img src="/img/<%= v.getCover()%>" style="width:100px;height:50px" /></a></td>
											<td><%= v.getName() %></td>
											<td><%= v.getUploadtime() %></td>
											<td>HD</td>
											<td class="w3-list-info"><a href="action.jsp"><%= v.getDesc() %></a></td>
											<td class="w3-list-info"><a href="action.jsp"><%=v.getType() %></a></td>
											<td>7.0</td>
										  </tr>
										  <%
										  a++;
										...
										%>
											<h1 style="padding:130px;">你还没投过稿！</h1>
										<%} %>
										</tbody>
									</table>
								</div>
