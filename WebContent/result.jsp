 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					...
					<!--/tv-movies-->
					<h3 class="agile_w3_title hor-t">搜索<span>结果</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
										...
										<%
											...
											List<VideosBean> list = videosDao.SeachDao(str);
											for(VideosBean videosBean : list){
												%>
												<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.jsp" class="hvr-sweep-to-bottom"><img src="/img/<%=videosBean.getCover() %>" title="Movies Pro" class="img-responsive" alt=" ">
													<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
												</a>
												<div class="mid-1 agileits_w3layouts_mid_1_home">
													<div class="w3l-movie-text">
														<h6><a href="single.jsp"><%=videosBean.getName() %></a></h6>							
													</div>
													<div class="mid-2 agile_mid_2_home">
														<p><%=videosBean.getUploadtime() %></p>
