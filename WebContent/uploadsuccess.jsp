...
<meta http-equiv="refresh" content="3;url=uploaded.jsp" /> 
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					<div class="agile_featured_movies">
							<div class="inner-agile-w3l-part-head" style="padding:130px;">
					            <h3 class="w3l-inner-h-title">上传成功</h3>
							<p class="w3ls_head_para">5秒后，返回上传历史页面</p>
							</div>
					</div>
				</div>
			<!--//content-inner-section-->
